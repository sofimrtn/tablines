...
class AutogeneratorTest extends Autogenerator with JUnitSuite {
    ...
    @Test def testCreateValidVariable {
    	 
    	 assertEquals(Variable("?validVar"), validAutogeneratedTerms.createValidVariable("?validVar"))
    	 assertEquals(Variable("?validVar"), validAutogeneratedTerms.createValidVariable("?123validVar"))
    	 assertEquals(Variable("?validVar"), validAutogeneratedTerms.createValidVariable("?valid_Var"))
    	 assertEquals(Variable("?validVar"), validAutogeneratedTerms.createValidVariable("?v¡añl¿i'dV._ar"))
    	 assertEquals(Variable("?validVar"), validAutogeneratedTerms.createValidVariable("?9067val_id V.a-r"))
    }	
    
    @Test def testCreateValidProperty {
    	 
    	 assertEquals("property1", validAutogeneratedTerms.createValidProperty("property_1"))
    	 assertEquals("CODC10", validAutogeneratedTerms.createValidProperty("COD,C,10"))
    }	
}