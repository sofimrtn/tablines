...
class ProjectController {
    ...
    private def indexModel(String projectId) {
        return [path: projectService.inputDir,
    ...
    def saveProgram = {
        ...
        try {
            ...
            render(view: "index", model: indexModel(params.id) + [program: program])
    ...
    def downloadSource = {
        ...
        try {
            ...
            render(view: "index", model: indexModel(params.id) + [sourceUrl: params.sourceUrl])
        } catch (Exception e) {
    ...
    def autogenerateProgram = {
        ...
        render(view: "index", model: indexModel(params.id))
    }
