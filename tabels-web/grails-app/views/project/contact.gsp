    ...
    <body>
    	...
    	<div class="projectListBox homePage">
			...
			<p><strong>Tabels</strong> is an on-going work developed by researchers from <a href="http://fundacionctic.org/en">CTIC</a>. Please, contact
	    		...
	    		<p>We are open to collaborations and would like to get to know what data problems <strong>Tabels</strong> may 
	    		    suit for. Feedback is more than welcome about tabular formats, spread files in organizations, 
	    		    data visualization and integration issues or other.</p> 
