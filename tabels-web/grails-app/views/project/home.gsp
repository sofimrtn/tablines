<html>
    ...
    <body class="homePage">
    	<div class="projectListBox">
			...
			<h3 class="accordion"> Tabels language</h3>
			<div>
			...
			<h3 class="accordion">Data mediation and manipulation</h3>
			<div>
				<p>FIXME</p>
			</div>

			<h3 class="accordion">Entity recognition and reconciliation</h3>
			<div>
				<p></p>
			</div>

			<h3 class="accordion">APIs and data access</h3>
			<div>
				<p>FIXME </p>
			</div>
	
			<h3 class="accordion">Charts and statistics</h3>
			<div>
			...
			<h3 class="accordion">Maps and geographic data</h3>
			<div>	
